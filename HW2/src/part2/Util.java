...
public final class Util {
    ...
    public boolean customerExist( Customer newCustomer,
    ...
    public void checkInput(String[] command, State state, String type) throws
            IllegalOperationRequest, CustomerTypeIllegalException , ProviderNotFoundException{
